      ...
      <div className="grid grid-cols-12 mt-5">
        ...
        <div className="col-span-6 flex justify-center items-center">
          <div className='px-20 leading-2'>
            ...
            <button className="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded" onClick={() => setShowRegisterModal(true)}>REGISTER HERE</button>
          </div>
        </div>
      </div>
      {showRegisterModal && (
...
<div className="grid grid-cols-3 gap-4 mt-4">
  ...
  <div className="flex flex-col justify-center items-center w-80">
    ...
    <div className="text-container">
      ...
      <div className="text-gray-50">1 day ago</div>
    </div>
  </div>
  ...
  <div className="flex flex-col justify-center items-center w-80">
    ...
    <div className="text-container">
      ...
      <div className="text-gray-50">4 day ago</div>
    </div>
  </div>
  ...
  <div className="flex flex-col justify-center items-center w-80">
    ...
    <div className="text-container">
      ...
      <div className="text-gray-50">7 day ago</div>
    </div>
  </div>
  </div>
</div>
